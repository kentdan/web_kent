...
import kentImg from "@/app/blog/_assets/images/authors/Kent_tp.jpg";
...
export const authors = {
  kent: {
    slug: "kent",
    name: "Kent Daniel",
    role: "I write random things",
    avatar: kentImg,
    description:
      "I like doing something cool'.",
    // social: [
    //   {
    //     name: "Twitter",
...
export const styles = {
  h2: "text-3xl font-bold text-white mb-6",
  h3: "text-2xl font-bold text-white mb-4",
  p: "text-gray-300 mb-6 leading-relaxed",
  ul: "list-inside list-disc text-gray-300 text-lg mb-6 space-y-2",
  li: "list-item",
  code: "text-sm font-mono bg-gray-900 text-gray-300 p-6 rounded-lg my-4 overflow-x-scroll select-all",
  codeInline: "text-sm font-mono bg-gray-900 text-gray-300 px-2 py-1 rounded-md select-all",
  link: "text-white hover:text-gray-300 transition-colors duration-300",
  section: "mb-12",
};
